...
Component.options.__file = "resources/assets/js/components/TweetCard.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4197dc7a", Component.options)
  } else {
    hotAPI.reload("data-v-4197dc7a", Component.options)
' + '  }
...
Vue.component('tweets', __webpack_require__(39));
Vue.component('feeds', __webpack_require__(44));
Vue.component('stories', __webpack_require__(47));
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2f7c5ed8", Component.options)
  } else {
    hotAPI.reload("data-v-2f7c5ed8", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TweetCard_vue__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__TweetCard_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__TweetCard_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_infinite_loading__ = __webpack_require__(2);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        tweet: __WEBPACK_IMPORTED_MODULE_0__TweetCard_vue___default.a,
        ...
        loadmore: function loadmore($state) {
            ...
            if (this.pageNo !== null) {
                axios({
                    ...
                    $state.loaded();
                    _this.pageNo = res.data.data.next_page_url;
                    for (var i = 0; i < res.data.data.data.length; i++) {
                        _this.tweets.push(res.data.data.data[i]);
                    }
                });
            } else {
                $state.complete();
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "col-md-4 tweet", staticStyle: { "margin-top": "40px" } },
    [
      _c("a", { attrs: { href: "https://twitter.com/" + _vm.tweet.handle } }, [
        _c("h4", [_vm._v(_vm._s(_vm.tweet.name))])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "row summary" }, [
        _vm._v(_vm._s(_vm.tweet.tweet))
      ]),
      _vm._v(" "),
      _c("span", [
        _c("i", { staticClass: "fa fa-retweet" }),
        _vm._v(" " + _vm._s(_vm.tweet.retweets) + "  ")
      ]),
      _vm._v(" "),
      _c("br")
    ]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4197dc7a", module.exports)
  }
}
    ...
    [
      _vm.loading != false
        ? _c(
            ...
            [
              _c("i", { staticClass: "fa fa-spinner fa-5x fa-spin" }),
              _vm._v(" "),
              _c("p", { staticClass: "text-center" }, [
                _vm._v("Loading tweets ... ")
              ])
            ]
          )
        : _vm._e(),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2f7c5ed8", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/FeedsComponent.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4816d042", Component.options)
  } else {
    hotAPI.reload("data-v-4816d042", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
        ...
        loadmore: function loadmore($state) {
            ...
            axios({
                ...
                for (var i = 0; i < res.data.data.length; i++) {
                    _this.tweets.push(res.data.data[i]);
                }
            });
        }
    },
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "transition-group",
        { attrs: { name: "fade", tags: "div" } },
        _vm._l(_vm.tweets, function(tweet, index) {
          return _c(
            "div",
            {
              key: index,
              staticClass: "col-md-4 tweet",
              staticStyle: { "margin-top": "40px" }
            },
            [
              _c(
                ...
                [_c("h4", [_vm._v(_vm._s(tweet.user.name))])]
              ),
              _vm._v(" "),
              _c("div", { staticClass: "row summary" }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4816d042", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/StoriesComponent.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-19ee21be", Component.options)
  } else {
    hotAPI.reload("data-v-19ee21be", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_infinite_loading__ = __webpack_require__(2);
    ...
    [
      ...
      _c(
        ...
        _vm._l(_vm.stories, function(story, index) {
          return _c(
            "div",
            { key: index, staticClass: "col-md-12 incident-header" },
            [
              _c("a", { attrs: { href: "/incidents/" + story.id } }, [
                _c("h4", [
                  _vm._v(_vm._s(story.name)),
                  _c("small", { staticClass: "pull-right" }, [
                    _c("i", { staticClass: "fa fa-map-marker" }, [
                      _vm._v(" " + _vm._s(story.location.name))
                    ]),
                    _vm._v("   "),
                    _c("i", { staticClass: "fa fa-clock-o" }, [
                      _vm._v(" " + _vm._s(story.year))
                    ])
                  ])
                ])
              ]),
              ...
              _c("div", {
                ...
                domProps: { innerHTML: _vm._s(story.summary) }
              })
            ]
          )
        })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-19ee21be", module.exports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DeleteCard_vue__ = __webpack_require__(52);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DeleteCard_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__DeleteCard_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_infinite_loading__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_infinite_loading___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vue_infinite_loading__);
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        tweet: __WEBPACK_IMPORTED_MODULE_0__DeleteCard_vue___default.a,
        InfiniteLoading: __WEBPACK_IMPORTED_MODULE_1_vue_infinite_loading___default.a
    },
    methods: {
        removeTweet: function removeTweet(item) {
            var _this = this;
            ...
            axios({
                ...
                _this.actions = [];
                _this.tweets.splice(_this.tweets.indexOf(item), 1);
                _this.actions = actions;
            });
        },
        updateActions: function updateActions(item) {
        ...
        loadmore: function loadmore($state) {
            ...
            if (this.pageNo !== null) {
                axios({
                    ...
                    $state.loaded();
                    _this2.pageNo = res.data.data.next_page_url;
                    for (var i = 0; i < res.data.data.data.length; i++) {
                        _this2.tweets.push(res.data.data.data[i]);
                    }
                });
            } else {
                $state.complete();
...
Component.options.__file = "resources/assets/js/components/DeleteCard.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6051cf52", Component.options)
  } else {
    hotAPI.reload("data-v-6051cf52", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
    ...
    methods: {
        ...
        update: function update(item) {
            ...
            axios({
                ...
                console.log(response, _this.checked);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6051cf52", module.exports)
  }
}
    ...
    [
      ...
      _c(
        ...
        _vm._l(_vm.tweets, function(tweet, index) {
          return _c("tweet", {
            key: index,
            attrs: { tweet: tweet, actions: _vm.actions },
            on: { remove: _vm.removeTweet, update: _vm.updateActions }
          })
        })
      ),
      _vm._v(" "),
